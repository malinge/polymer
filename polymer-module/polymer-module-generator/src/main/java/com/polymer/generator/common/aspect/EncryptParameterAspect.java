package com.polymer.generator.common.aspect;

import com.polymer.framework.common.pojo.PageResult;
import com.polymer.framework.common.pojo.Result;
import com.polymer.generator.common.annotation.EncryptParameter;
...
public class EncryptParameterAspect {
     ...
     */
    @Around("execution(* com.polymer.generator.controller.DataSourceController.*(..))")
    ...
    private void handleObject(Object object) {
        ...
        if (data instanceof List) {
            ...
            List<?> itemList = pageResult.getList();
            for (Object item : itemList) {
                handleItem(item, false);
            }
        } else {
    ...
    private void handleItem(Object item, boolean isDecrypt) {
        ...
        // 只处理在entity包下面的对象
        if (Objects.isNull(item.getClass().getPackage()) || !item.getClass().getPackage().getName().startsWith("com.polymer.generator.entity")) {
            return;
        }
