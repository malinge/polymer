package com.polymer.generator.config;

import com.polymer.generator.common.utils.DbUtils;
import com.polymer.generator.common.utils.EncryptUtils;
import com.polymer.generator.config.query.AbstractQuery;
import com.polymer.generator.config.query.ClickHouseQuery;
import com.polymer.generator.config.query.DmQuery;
import com.polymer.generator.config.query.MySqlQuery;
import com.polymer.generator.config.query.OracleQuery;
import com.polymer.generator.config.query.PostgreSqlQuery;
import com.polymer.generator.config.query.SQLServerQuery;
...
public class GenDataSource {
    ...
    public GenDataSource(DatasourceEntity entity) {
        ...
        try {
            this.password = EncryptUtils.decrypt(entity.getPassword());
