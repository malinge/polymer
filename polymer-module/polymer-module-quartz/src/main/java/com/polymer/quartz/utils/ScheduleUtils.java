package com.polymer.quartz.utils;

import com.polymer.framework.common.exception.ServiceException;
import com.polymer.quartz.entity.ScheduleJobEntity;
import com.polymer.quartz.enums.ScheduleConcurrentEnum;
import com.polymer.quartz.enums.ScheduleStatusEnum;
import com.polymer.quartz.service.impl.ScheduleConcurrentExecutionImpl;
import com.polymer.quartz.service.impl.ScheduleDisallowConcurrentExecutionImpl;
...
public class ScheduleUtils {
    ...
    public static Class<? extends Job> getJobClass(ScheduleJobEntity scheduleJob) {
        if (scheduleJob.getConcurrent().equals(ScheduleConcurrentEnum.NO.getValue())) {
            return ScheduleDisallowConcurrentExecutionImpl.class;
        } else {
            return ScheduleConcurrentExecutionImpl.class;
        }
    }
    ...
    public static void resumeJob(Scheduler scheduler, ScheduleJobEntity scheduleJob) {
        try {
            ...
            throw new ServiceException("恢复定时任务失败", e);
        }
    }
