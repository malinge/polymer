package com.polymer.gen.common.utils;
...
public class GenUtils {
    ...
    public static TableEntity getTable(GenDataSource datasource, String tableName) {
        ...
        throw new ServiceException("数据表不存在：" + tableName);
    }
    ...
    public static List<TableFieldEntity> getTableFieldList(GenDataSource datasource, Long tableId, String tableName) {
        System.out.println("表主键："+tableId);
        ...
        try {
            ...
            while (rs.next()) {
                ...
                System.out.println("字段名称："+ rs.getString(query.fieldName()));
                ...
                field.setExtra(rs.getString(query.extra()));
    ...
    public static String getFunctionName(String tableName) {
        String functionName = StringUtils.subAfter(tableName, "_", false);
        if (StringUtils.isBlank(functionName)) {
            functionName = tableName;
        }

        return StringUtils.toCamelCase(functionName);
    }
