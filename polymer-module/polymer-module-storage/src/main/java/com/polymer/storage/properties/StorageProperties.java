 ...
 * @author polymer
 */
@ConfigurationProperties(prefix = "polymer.storage")
public class StorageProperties {
     ...
     * RustFs配置项
     */
    private RustFsStorageProperties rustfs;
    ...
    public RustFsStorageProperties getRustfs() {
        return rustfs;
    }

    public void setRustfs(RustFsStorageProperties rustfs) {
        this.rustfs = rustfs;
    }
